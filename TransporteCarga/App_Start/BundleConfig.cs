...
namespace TransporteCarga
{
    public class BundleConfig
    {
        ...
        public static void RegisterBundles(BundleCollection bundles)
        {
            ...
            // Autocomplete Styless
            bundles.Add(new StyleBundle("~/Content/plugins/autocomplete/autocompleteStyles").Include(
                      "~/Content/plugins/autocomplete/autocomplete.min.css"));
